...
module bindbc.hb.bind.aat.layout;
...
static if (hbSupport >= HBSupport.v2_6_3)
{
	...
	version(BindHB_Static)
		uint hb_aat_layout_get_feature_types (
			hb_face_t* face,
			uint start_offset,
			uint* feature_count,
	...
	{
		private alias fp_hb_aat_layout_get_feature_types = uint function (
			hb_face_t* face,
			uint start_offset,
			uint* feature_count,
			hb_aat_layout_feature_type_t* features);
		__gshared fp_hb_aat_layout_get_feature_types hb_aat_layout_get_feature_types;
	}
	...
	{
		private alias fp_hb_aat_layout_feature_type_get_name_id = hb_ot_name_id_t function (
			hb_face_t* face,
			hb_aat_layout_feature_type_t feature_type);
		__gshared fp_hb_aat_layout_feature_type_get_name_id hb_aat_layout_feature_type_get_name_id;
	}
	...
	enum HB_AAT_LAYOUT_NO_SELECTOR_INDEX = 0xFFFFu;
	...
	{
		private alias fp_hb_aat_layout_feature_type_get_selector_infos = uint function (
			hb_face_t* face,
			hb_aat_layout_feature_type_t feature_type,
			uint start_offset,
			uint* selector_count,
			hb_aat_layout_feature_selector_info_t* selectors,
			uint* default_index);
		__gshared fp_hb_aat_layout_feature_type_get_selector_infos hb_aat_layout_feature_type_get_selector_infos;
	}
	...
	{
		private alias fp_hb_aat_layout_has_substitution = hb_bool_t function (hb_face_t* face);
		__gshared fp_hb_aat_layout_has_substitution hb_aat_layout_has_substitution;
	}
	...
	{
		private alias fp_hb_aat_layout_has_positioning = hb_bool_t function (hb_face_t* face);
		__gshared fp_hb_aat_layout_has_positioning hb_aat_layout_has_positioning;
	}
	...
	{
		private alias fp_hb_aat_layout_has_tracking = hb_bool_t function (hb_face_t* face);
		__gshared fp_hb_aat_layout_has_tracking hb_aat_layout_has_tracking;
	}
}
